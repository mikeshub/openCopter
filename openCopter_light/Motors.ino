...
void MotorHandler(){
  if (rcCommands.values.throttle < 1100){
    ...
    motorCommand1 = constrain((rcCommands.values.throttle + adjustmentX + adjustmentY - adjustmentZ),1000,2000);
    motorCommand2 = constrain((rcCommands.values.throttle - adjustmentX + adjustmentY + adjustmentZ),1000,2000);
    motorCommand3 = constrain((rcCommands.values.throttle - adjustmentX - adjustmentY - adjustmentZ),1000,2000);
    motorCommand4 = constrain((rcCommands.values.throttle + adjustmentX - adjustmentY + adjustmentZ),1000,2000);
